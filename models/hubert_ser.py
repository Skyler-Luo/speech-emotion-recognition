...
class HuBERT_SER(nn.Module):
    """HuBERT-based speech emotion recognition.

    Args:
        pretrained_path:          HF model id or local path for HuBERT
    ...
    def __init__(self,
                 pretrained_path: str = 'facebook/hubert-base-ls960',
                 num_classes: int = 5,
                 pool: str = 'attn',
        ...
        self.encoder = HubertModel.from_pretrained(pretrained_path)
    ...
    def unfreeze_feature_extractor(self):
        ...
        print("HuBERT feature_extractor unfrozen")


def get_feature_extractor(pretrained_path: str = 'facebook/hubert-base-ls960'):
...
def get_model(num_classes: int = 5,
              ...
              pool: str = 'attn',
              freeze_feature_extractor: bool = True,
              dropout: float = 0.3) -> HuBERT_SER:
    """Return a HuBERT_SER instance."""
    return HuBERT_SER(
