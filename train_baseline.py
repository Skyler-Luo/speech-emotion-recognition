...
from models.ser_baseline import (
    get_model, extract_baseline_feature, SERBaselineModel
)
...
class BaselineEmotionDataset(Dataset):
    ...
    def __init__(self, dataset_dir: str,
        ...
        print(f"[BaselineDataset] {len(file_list)} 个文件 | {dataset_dir}")
...
def train(args):
    ...
    logger.log(f"模型: SERBaselineModel  可训练参数: {n_params:,}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CNN-BiLSTM Baseline 训练')

    # 基本
    parser.add_argument('--experiment_name', type=str, default='Baseline_SER')
